...
8. For each chapter, create bilingual companion notes before the Chinese chapter.
9. For each English chapter, create a learning-priority vocabulary list before the English chapter.
10. Assemble the bilingual EPUB with a usable table of contents.
11. Run the quality checklist before finishing.
...
Each chapter should begin with companion notes before the Chinese chapter.
...
- Confirm the guide reflects the user's choices: chapter-level alignment, deep bilingual companion notes, learning-priority vocabulary, faithful readable translation, and an agent-guide-first project shape.
